...
// Not a staff role. The portal has no roles, so "patient" is passed where a
// role goes and the existing filter keeps the two lists apart — no second
// search path, no second matcher to keep in step with this one.
...
const ENTRIES = [
  ...
  // ---- The patient portal -------------------------------------------------
  // A separate, much shorter list. The staff answers above would be worse than
  // useless here: a patient cannot dispense medicine or open a report, and
  // explaining how would be a confidently wrong answer — the failure we chose
  // this whole design to avoid. There are six questions because there are
  // about six things a patient can do.
  //
  // Answered in the second person and in Tagalog throughout, because the
  // people reading this are the beneficiaries, not the staff.
  {
    id: "p-schedule",
    q: "Saan ko makikita ang schedule ko?",
    qEn: "Where do I see my next appointment?",
    tags: ["Appointment"],
    keys: ["schedule", "iskedyul", "appointment", "kailan", "balik", "punta",
           "susunod", "next", "saan", "asan", "tingnan", "makita", "petsa"],
    roles: PATIENT_ROLE,
    short: "Nasa pinakataas ng page pagka-sign in mo.",
    steps: [
      "Mag-sign in sa portal.",
      "Ang <b>Next appointment</b> sa pinakataas ay ang susunod mong punta.",
      "Sa ilalim nito, sa <b>My appointments</b>, nandoon lahat — pati ang mga nakaraan na.",
      "Kapag walang nakalagay, wala pa kayong naka-schedule. Ang clinic staff ang naglalagay nito.",
    ],
    go: { href: "/portal", label: "Buksan ang portal ko" },
  },
  {
    id: "p-book",
    q: "Bakit hindi ako makapag-book ng sarili kong appointment?",
    qEn: "Why can't I book my own appointment?",
    tags: ["Appointment"],
    keys: ["book", "magbook", "magpaschedule", "bakit", "hindi", "kaya",
           "makapag", "mag-book", "gumawa", "palit", "kansela", "cancel",
           "reschedule", "baguhin"],
    roles: PATIENT_ROLE,
    short: "Ang clinic staff ang humahawak ng kalendaryo. Sabihin lang sa kanila.",
    steps: [
      "Hindi po pwedeng mag-book, magpalit o magkansela mula rito — sinasadya ito.",
      "Isang kalendaryo lang ang hawak ng clinic at sila ang nagbabalanse nito, kaya kung dalawa ang naglalagay, magkakadoble ang schedule.",
      "Sabihin sa clinic staff sa susunod na punta, o tumawag.",
      "Basta may naka-schedule ka na, makikita mo siya rito, at padadalhan ka ng paalala sa email isang araw bago.",
    ],
    go: { href: "/portal", label: "Buksan ang portal ko" },
  },
  {
    id: "p-password",
    q: "Paano ko papalitan ang password ko?",
    qEn: "How do I change my portal password?",
    tags: ["Account"],
    keys: ["password", "palit", "palitan", "baguhin", "bago", "change",
           "account", "pasword", "sarili"],
    roles: PATIENT_ROLE,
    short: "Nasa ibaba ng portal page, sa Account settings.",
    steps: [
      "Mag-scroll pababa sa dulo ng portal page.",
      "Hanapin ang bahagi para sa password.",
      "Ilagay ang luma mong password, tapos ang bago nang dalawang beses.",
      "Walong titik pataas ang bago. Masi-sign out ka sa ibang telepono o computer — normal lang iyon.",
      "Tatlong palit lang kada araw. Kung mauubos mo, gamitin ang <b>Nakalimutan ang password</b> sa sign-in page.",
    ],
    go: { href: "/portal", label: "Buksan ang portal ko" },
  },
  {
    ...
    qEn: "I forgot my portal password.",
    tags: ["Account"],
    keys: ["nakalimutan", "limot", "forgot", "hindi", "makapasok", "pasok",
           "login", "signin", "sign", "in", "locked", "sarado", "password"],
    roles: PATIENT_ROLE,
    short: "May Nakalimutan ang password sa sign-in page. Padadalhan ka ng link sa email.",
    steps: [
      "Sa sign-in page, pindutin ang <b>Forgot password?</b>",
      "Ilagay ang email na naibigay mo sa clinic.",
      "Bubuksan mo ang link na dumating sa email, tapos doon ka gagawa ng bago.",
      "Kung pareho ang email niyo ng kapamilya, may sariling nakapangalang link ang bawat isa — piliin ang sa'yo.",
      "Kung wala kang email, sabihin sa clinic staff at sila ang magre-reset.",
    ],
    go: { href: "/portal/recover", label: "Buksan ang Forgot password" },
  },
  {
    id: "p-records",
    q: "Saan ko makikita ang bakuna at gamot na natanggap ko?",
    qEn: "Where are my immunization and medicine records?",
    tags: ["Record"],
    keys: ["bakuna", "turok", "immunization", "gamot", "medicine", "natanggap",
           "record", "kard", "card", "saan", "asan", "tingnan", "makita",
           "history", "kasaysayan"],
    roles: PATIENT_ROLE,
    short: "Sa gitna ng portal page — Medicines I received at My immunization card.",
    steps: [
      "Mag-scroll pababa mula sa appointments.",
      "Sa <b>Medicines I received</b>, nandoon ang mga gamot na ibinigay sa'yo ng clinic.",
      "Sa <b>My immunization card</b>, ito ang parehong Todo Ligtas card na hawak nila sa papel.",
      "Ang blangkong kahon ay dose na hindi pa naitala rito. Itanong sa staff sa susunod na punta kung sa tingin mo ay nabakunahan na.",
    ],
    go: { href: "/portal", label: "Buksan ang portal ko" },
  },
  {
    id: "p-wrong",
    q: "Mali ang detalye ko. Paano ko itatama?",
    qEn: "My information is wrong. How do I fix it?",
    tags: ["Account"],
    keys: ["mali", "maling", "itama", "ayusin", "baguhin", "palitan", "edit",
           "detalye", "pangalan", "address", "numero", "kaarawan", "birthday",
           "email", "wrong"],
    roles: PATIENT_ROLE,
    short: "Ang clinic lang ang makakapagbago ng record. Sabihin sa kanila.",
    steps: [
      "Hindi mo po kayang baguhin ang record mo mula rito, at sinasadya rin ito — medical record ito, kaya isang lugar lang ang pwedeng magbago nito.",
      "Sabihin sa clinic staff sa susunod mong punta kung alin ang mali.",
      "Sila na ang magbabago, tapos makikita mo agad dito pagkatapos.",
    ],
    go: { href: "/portal", label: "Buksan ang portal ko" },
  },
  {
    id: "p-family",
    q: "Paano ko makikita ang record ng anak ko?",
    qEn: "How do I see my child's records?",
    tags: ["Record"],
    keys: ["anak", "bata", "child", "pamilya", "family", "kapamilya",
           "dependent", "asawa", "magulang", "guardian", "household", "record"],
    roles: PATIENT_ROLE,
    short: "Kung ikaw ang naitalang guardian nila, lalabas sila sa portal mo.",
    steps: [
      "Mag-sign in, tapos hanapin ang listahan ng kapamilya sa portal page.",
      "Pindutin ang pangalan nila para makita ang schedule at bakuna nila.",
      "Kung wala silang lumalabas, hindi pa kayo naka-ugnay sa record. Sabihin sa clinic staff at sila na ang magdudugtong.",
    ],
    go: { href: "/portal", label: "Buksan ang portal ko" },
  },
];

module.exports = { ENTRIES, ALL, REPORTS, CLINICAL, ADMIN, PATIENT_ROLE };
