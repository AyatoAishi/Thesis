...
module.exports = [
  ...
  // `sex` restricts who this row is offered to. The DOH school-based HPV
  // programme covers Grade 4 girls only, so offering it on a boy's card is an
  // invitation to a mis-record. Only HPV carries it; nothing else on this
  // schedule is sex-specific.
  //
  // Note it is a restriction on what is OFFERED, not on what can be stored. A
  // dose already recorded is still shown, whatever the patient's sex — a record
  // that exists is a fact, and hiding it would be losing history rather than
  // correcting it.
  { name: "Human Papillomavirus Vaccine", category: "school", schedule: "Grade 4, female 9–14 y/o", doses: 2, sex: "female" },
